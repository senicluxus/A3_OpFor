class CfgPatches
{
	class A3_Opf_Data_F_Opf_Loadorder
	{
		...
		requiredAddons[] =
		{
            ...
            A3_Opf_Structures_F_Opf_Civilian,
            A3_Opf_Structures_F_Opf_Civilian_Dead,
            A3_Opf_Structures_F_Opf_Military,
            A3_Opf_Structures_F_Opf_Military_Flags,
            A3_Opf_Supplies_F_Opf,
